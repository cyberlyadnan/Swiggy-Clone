...
const Contact = () => {
    ...
    return (
        <>
            <section className="bg-blue-50 dark:bg-slate-800 px-20"  id="contact">
                <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-10">
                    <div className="mb-4">
                        <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                            ...
                            Reach out today and let's turn your ideas into reality together!
                            </p>
                        </div>
                    </div>
                    <div className="flex items-stretch justify-center">
                        <div className="grid md:grid-cols-2">
                            <div className="h-full pr-6">
                                ...
                                Embark on a journey of collaboration and innovation with us. Whether you're dreaming up the next big project or need expert guidance, our team is here to listen, advise, and bring your visions to life.
                                </p>
                                <ul className="mb-6 md:mb-0">
                                    <li className="flex">
                                        ...
                                        <div className="ml-4 mb-4">
                                            ...
                                            <p className="text-gray-600 dark:text-slate-400">Qazi Street</p>
                                            <p className="text-gray-600 dark:text-slate-400">Saharanpur, India</p>
                                        </div>
                                    </li>
                                    <li className="flex">
                                        <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                                        ...
                                        <div className="ml-4 mb-4">
                                            ...
                                            <p className="text-gray-600 dark:text-slate-400">Mail: adnanahmad9334@gmail.com</p>
                                        </div>
                                    </li>
                                    <li className="flex">
                                        <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
